  ...
  auto context =
    VkBindless::Context::create([win = window](VkInstance instance) {
      ...
      if (glfwCreateWindowSurface(
            instance, win, nullptr, &surface) != VK_SUCCESS) {
...
TEST_CASE("Create a white texture and make sure it's valid")
{
  ...
  auto texture_desc = VkBindless::VkTextureDescription{
    ...
    .extent = { 1, 1, 1 },
    .usage_flags = VkBindless::TextureUsageFlags::Sampled | VkBindless::TextureUsageFlags::Storage,
    .debug_name = "White Texture"
  };

  auto texture_handle =
    VkBindless::VkTexture::create(*context, texture_desc);
